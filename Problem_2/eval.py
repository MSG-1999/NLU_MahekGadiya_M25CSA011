...
# BLSTM model (better at capturing long dependencies)
...
# attention module (same as before, causal masking)
...
if __name__ == "__main__":
    ...
    # same hyperparameters used for all models
    E, H, L = 64, 256, 2
    ...
    # printing number of parameters for comparison
